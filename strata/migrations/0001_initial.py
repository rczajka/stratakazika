...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('strata_counter', (
            ...
            ('money', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=7, decimal_places=2, db_index=True)),
        ))
        db.send_create_signal('strata', ['Counter'])

        # Adding model 'CounterInc'
        db.create_table('strata_counterinc', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('counter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['strata.Counter'])),
            ('money', self.gf('django.db.models.fields.DecimalField')(max_digits=7, decimal_places=2)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('strata', ['CounterInc'])


    def backwards(self, orm):
        # Deleting model 'Counter'
        db.delete_table('strata_counter')

        # Deleting model 'CounterInc'
        db.delete_table('strata_counterinc')
    ...
    models = {
        'strata.counter': {
            ...
            'money': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '7', 'decimal_places': '2', 'db_index': 'True'}),
